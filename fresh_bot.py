...
RECENT_REPLIES_FILE = "recent_replies.json"  # ← НОВЫЙ ФАЙЛ
MAX_RECENT = 20  # ← ХРАНИМ ПОСЛЕДНИЕ 20 ОТВЕТОВ
...
# === НОВЫЕ ФУНКЦИИ ДЛЯ ИСТОРИИ ОТВЕТОВ ===
...
async def main():
    async with httpx.AsyncClient() as client:
        ...
        for notif in notifications:
            ...
            # === FILTERING: only direct mentions or replies to bot ===
            should_process = True
